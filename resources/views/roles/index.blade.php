                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                  <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="modal" data-bs-target="#addrole" href="javascript:;" role="tab" aria-selected="true">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header text-center">
              <h4 class="modal-title w-100 font-weight-bold">Ajouter un role</h4>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="javascript:;">
                            <i class="fas fa-trash  text-sm" data-bs-toggle="modal" data-bs-target="#deleterole{{$role->id}}"  data-bs-placement="top" title="Delete role" style="color: red;"></i>
                          </a>
                      </td>
                    </tr>
                        ...
                        <div class="modal-content">
                          <div class="modal-header text-center">
                            ...
                            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                              ...
                              <div class="modal-footer d-flex justify-content-center">
                                  <a href="/admin/roles/delete/{{$role->id}}"><button class="btn btn-secondary"> OUI <i class="fas fa-paper-plane-o ml-1"></i></button></a>
