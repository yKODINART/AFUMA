                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                  <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="modal" data-bs-target="#addpermission" href="javascript:;" role="tab" aria-selected="true">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header text-center">
              <h4 class="modal-title w-100 font-weight-bold">Ajouter une permission</h4>
              <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="/admin/permissions/store" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="align-middle  text-sm">
                            <span class="text-xs font-weight-bold">{{$permission->name}}  </span>
                        </td>
                      <td>
                          <a href="/admin/permissions/edit/{{$permission->id}}">
                            <i class="fas fa-user-edit  text-sm" title="Edit role" style="color: blue;"></i>
                          </a> &nbsp;
                          <a href="javascript:;">
                            <i class="fas fa-trash  text-sm" data-bs-toggle="modal" data-bs-target="#deletepermission{{$permission->id}}"  data-bs-placement="top" title="Delete role" style="color: red;"></i>
                          </a>
                      </td>
                    </tr>
                          ...
                          <div class="modal-header text-center">
                            ...
                            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                                  ...
                                  <p> Confirmer la suppression de la permission {{$permission->name}} ?</p>
                            
                              <div class="modal-footer d-flex justify-content-center">
                                  <a href="/admin/permissions/delete/{{$permission->id}}"><button class="btn btn-secondary"> OUI <i class="fas fa-paper-plane-o ml-1"></i></button></a>
