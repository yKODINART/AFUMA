        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{asset('assets2/img/home-3.jpg')}}" alt="Image">
        ...
        <div class="row g-4">
            ...
            <div class="service-item p-4">
                <div class="overflow-hidden mb-4 position-relative">
                    <img class="img-fluid" src="{{asset('assets2/img/blog0.jpg')}}" alt="">
                </div>
                <p class="blog-meta">
        ...
        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s"
            ...
            <div class="service-item p-4">
                <div class="overflow-hidden mb-4">
                    <img class="img-fluid" src="{{asset('assets2/img/fab0.jpg')}}" alt="" style="object-fit: cover;">
                </div>
                <p class="blog-meta">
                    <span class="author me-2"><i class="fa fa-user text-primary"></i> Afuma</span>
                    <span class="date"><i class="fas fa-calendar text-primary"></i> 27 Décembre 2019</span>
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.7s" style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInUp;">
                <div class="service-item p-4">
                    <div class="overflow-hidden mb-4">
                        <img class="img-fluid" src="{{asset('assets2/img/stage.jpg')}}" alt="">
                    </div>
                    <p class="blog-meta">
                        <span class="author me-2"><i class="fa fa-user text-primary"></i> Afuma</span>
                        <span class="date"><i class="fas fa-calendar text-primary"></i> 27 Décembre 2019</span>
